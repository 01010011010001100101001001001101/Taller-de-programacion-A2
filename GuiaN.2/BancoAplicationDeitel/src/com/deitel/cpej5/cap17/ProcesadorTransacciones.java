...
// Fig. 17.21: ProcesadorTransacciones.java
...
public class ProcesadorTransacciones extends JFrame {
   ...
   public ProcesadorTransacciones()
   {
      ...
      // establecer el bot�n para cancelar
      botonCancelar = interfazUsuario.obtenerBotonHacerTarea2();
      botonCancelar.setText( "Cancelar" );
      botonCancelar.setEnabled( false );
      
      // registrar componente de escucha para el bot�n de cancelaci�n
      ...
      JMenuBar barraMenus = new JMenuBar(); // establecer el men�
      setJMenuBar( barraMenus );

      JMenu menuArchivo = new JMenu( "Archivo" );
      barraMenus.add( menuArchivo );
      
      // establecer elemento de men� para agregar un registro
      ...
      elementoNuevo.addActionListener( 
         ...
         new ActionListener() { // clase interna an�nima
            ...
            public void actionPerformed( ActionEvent evento ) 
            {
               ...
               // configurar los campos de la GUI para su edici�n
      ...
      // establecer elemento de men� para actualizar un registro
      ...
      // establecer elemento de men� para eliminar un registro
      ...
      // establecer elemento de men� para abrir archivo
      ...
      elementoAbrir.addActionListener( 
         ...
         new ActionListener() { // clase interna an�nima
            ...
            public void actionPerformed( ActionEvent evento ) 
            {
               ...
               // establecer los elementos del men�
      ...
      // establecer elemento de men� para salir del programa
      ...
      // adjuntar elementos de men� al men� Archivo
   ...
   private boolean abrirArchivo()
   {
      ...
      try {
         // llamar al m�todo ayudante para abrir el archivo
   ...
   private void realizarAccion( String accion )
   {
      try {
         ...
         if ( accion.equals( "Crear" ) )
            ...
            JOptionPane.showMessageDialog( this, "Acci�n incorrecta", 
               "Error al ejecutar la acci�n", JOptionPane.ERROR_MESSAGE );
   ...
   } // fin del m�todo mostrarRegistro
