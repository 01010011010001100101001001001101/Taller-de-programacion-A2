...
public class LeerArchivoSecuencial extends JFrame {
   ...
   public LeerArchivoSecuencial()
   {
      ...
      // obtener referencia al bot�n de tarea gen�rico hacerTarea1 de IUBanco
      ...
      // obtener referencia al bot�n de tarea gen�rico hacerTarea2 de IUBanco
   ...
   {
      // mostrar el cuadro de di�logo del archivo, para que el usuario pueda seleccionar el archivo a abrir
      JFileChooser selectorArchivo = new JFileChooser();
      selectorArchivo.setFileSelectionMode( JFileChooser.FILES_ONLY );

      int resultado = selectorArchivo.showOpenDialog( this );
 
      // si el usuario hizo clic en el bot�n Cancelar en el cuadro de di�logo, regresar
   ...
   public void leerRegistro()
   {
      ...
      // mostrar mensaje al llegar al fin del archivo
         ...
         JOptionPane.showMessageDialog( this, "No hay m�s registros en el archivo",
   ...
   private void cerrarArchivo()
   {
      ...
      // procesar excepci�n que puede ocurrir mientras se cierra el archivo
      catch ( IOException excepcionES ) {
